            ...
            <div className="container-information">
              ...
              <div className="flex-education">
                ...
                <p className="information-text-one">
                  Hello! my name is Audun, im 25 years old and looking for a job
                  in primarly Front End. I live in Kristiansand, but im not
                  ruling out moving to start my career! I have strong
                  fundamentals in programming, and currently working on getting
                  better at React.
                </p>
              </div>
              <div className="flex-education">
